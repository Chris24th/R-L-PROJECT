                                ...
                                />
                                    <Modal show={show} onHide={handleClose}>
                                        <Modal.Header closeButton>
                                            <Modal.Title><strong>Create Post</strong></Modal.Title>
                                        </Modal.Header>
                                        <Modal.Body>
                                            <Form>
                                                <Form.Group
                                                ...
                                                >
                                                    ...
                                                    {/* <Form.Control
                                                        ...
                                                        autoFocus
                                                    /> */}
                                                    <Form.Control placeholder="Share your thoughts" as="textarea" rows={10} />
                                                </Form.Group>
                                            </Form>
                                        </Modal.Body>
                                        <Modal.Footer>
                                            <button type="button" className="btn btn-light">
                                                {/* ICON FOR PHOTO */}
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" className="bi bi-images" viewBox="0 0 16 16">
                                                    <path d="M4.502 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3z"/>
                                                    <path d="M14.002 13a2 2 0 0 1-2 2h-10a2 2 0 0 1-2-2V5A2 2 0 0 1 2 3a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v8a2 2 0 0 1-1.998 2zM14 2H4a1 1 0 0 0-1 1h9.002a2 2 0 0 1 2 2v7A1 1 0 0 0 15 11V3a1 1 0 0 0-1-1zM2.002 4a1 1 0 0 0-1 1v8l2.646-2.354a.5.5 0 0 1 .63-.062l2.66 1.773 3.71-3.71a.5.5 0 0 1 .577-.094l1.777 1.947V5a1 1 0 0 0-1-1h-10z"/>
                                                </svg>{" "}
                                                    Photo
                                            </button>
                                            <Button className="btn btn-dark btn-rounded" onClick={handleClose}>
                                                Publish
                                            </Button>
                                        </Modal.Footer>
                                    </Modal>
                        ...
                        >
                            <div className="d-flex flex-row inputs p-2 py-4">
                                ...
                                <input
                                    ...
                                    required
                                />
>>>>>>> c2bc3339dccea75a5d60a9bdf150210c7d33445d
                            </div>
                            ...
                            <div className="d-flex flex-row justify-content-between align-items-start profile p-2">
                                <div className="d-flex align-items-center">
                                    ...
                                    <div className="d-flex flex-column ml-2 m-2 p-2 justify-content-between">
                                        <h6>{user ? user.fname : ""} {user ? user.lname : ""}</h6><span>{user && user.username}</span>
                                    </div>
                                    {/* Dropdown menu */}
                                    </div>
                                        <Dropdown>
                                            <Dropdown.Toggle className="btn btn-light" variant="light" id="dropdown-basic" bsPrefix="p-0">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"  className="bi bi-three-dots" viewBox="0 0 16 16">
